...
from battle.views import TeamView
...
#     @patch('battle.views.run_battle_and_send_result_email')
#     def test_if_task_run_battle_is_called(self, task_mock):
#         battle = Battle.objects.create(creator=self.user, opponent=self.opponent)
...
#             reverse("team_create", kwargs=kwargs), pokemons_data)

#         request.user = self.user
#         response = setup_view(TeamView(), request)
